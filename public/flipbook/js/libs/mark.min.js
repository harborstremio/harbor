          ...
          [
            ...
            },
            {
              ...
              value: function (e, t, n, r, o) {
                for (
                  var i, a, s, c = this, u = this.createIterator(t, e, r), l = [], h = [];
                  (s = void 0), (s = c.getIteratorNode(u)), (a = s.prevNode), (i = s.node);
                )
                  (this.iframes &&
                    this.forEachIframe(
                      t,
                ...
                if (n.hasOwnProperty(i)) {
                  ...
                  (a.unshift(i),
                    (a = this.sortByLength(a)
                      .map(function (e) {
                        return (
                          "disabled" !== t.opt.wildcards && (e = t.setupWildcardsRegExp(e)),
                          (e = t.escapeStr(e))
                        );
                      })
                      .filter(function (e) {
                ...
                e && void 0 !== e.start
                  ? ((r = (n = parseInt(e.start, 10)) + parseInt(e.length, 10)),
                    this.isNumeric(e.start) && this.isNumeric(e.length) && r - t > 0 && r - n > 0
                      ? (o = !0)
                      : (this.log(
                          "Ignoring invalid or overlapping range: " + "".concat(JSON.stringify(e)),
                        ),
                        this.opt.noMatch(e)))
                  : (this.log("Ignoring invalid range: ".concat(JSON.stringify(e))),
                    this.opt.noMatch(e)),
            ...
            value: function (e, t, n) {
              ...
              return (
                (r = (s = s > i ? i : s) + parseInt(e.length, 10)) > i &&
                  ((r = i), this.log("End range automatically set to the max value of ".concat(i))),
                s < 0 || r - s < 0 || s > i || r > i
                  ? ((o = !1),
