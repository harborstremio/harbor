        ...
        >
          ...
          <div
            ...
            className={`relative flex h-24 shrink-0 items-center justify-center ${
              collapsed ? "" : "lg:justify-start lg:ps-[36px]"
            }`}
          >
            <button
              type="button"
            ...
            >
              <HarborMark className="h-[36px] w-[36px] shrink-0 drop-shadow-[0_0_10px_#88c0d05c]" />
              {!collapsed && (
                <span
          ...
          <nav data-tv-scroll-focus className="min-h-0 flex-1 overflow-y-auto pb-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          ...
          <div className={`relative shrink-0 px-3 pb-4 pt-2 ${collapsed ? "" : "lg:px-5"}`}>
...
function Station({
  ...
  return (
    <button
      ...
      className="group relative z-10 flex h-[72px] w-full items-center"
    >
      <span className="flex w-[100px] shrink-0 items-center justify-center">
        <span
          className={`relative grid h-14 w-14 place-items-center rounded-full transition-colors duration-200 ${
        ...
        >
          ...
          <span className="relative overflow-hidden [&_svg]:h-[36px] [&_svg]:w-[36px]">{item.render(false)}</span>
          {gated && (
            <span
              className="absolute -bottom-0.5 -end-0.5 z-10 flex h-5 w-5 items-center justify-center rounded-full bg-canvas text-ink-subtle"
      ...
      {!collapsed && (
        <span
          className={`hidden flex-1 pe-4 text-start text-[22px] tracking-tight transition-colors duration-200 lg:block ${
