...
export const DEFAULT: Settings = {
  ...
  streamPriority: [],
  animeIdPriority: [
    { prefix: "tt", label: "IMDb", enabled: true },
    { prefix: "kitsu", label: "Kitsu", enabled: false },
    { prefix: "mal", label: "MyAnimeList", enabled: false },
    { prefix: "anidb", label: "AniDB", enabled: false },
    { prefix: "anilist", label: "AniList", enabled: false },
    { prefix: "tmdb", label: "TMDB", enabled: false },
  ],
