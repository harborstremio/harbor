...
const contextActionsFallback: Record<string, string> = {
  "Download chapters": "Download chapters",
  "Read chapter": "Read chapter",
  "Manga download failed": "Manga download failed",
  "Manga source is no longer available": "Manga source is no longer available",
  "Copy magnet": "Copy magnet",
  "Select a subtitle track first.": "Select a subtitle track first.",
  "This Continue Watching entry is no longer available.":
    "This Continue Watching entry is no longer available.",
  "This episode has not aired yet.": "This episode has not aired yet.",
  ...
  "Play this same video from the beginning?": "Play this same video from the beginning?",
  "Opening playback…": "Opening playback…",
  "Continue last watched": "Continue last watched",
  "Local video": "Local video",
  "Open my profile": "Open my profile",
  "Add to page": "Add to page",
  "Download…": "Download…",
  "Choose a source to download this movie.": "Choose a source to download this movie.",
  "Choose source": "Choose source",
  "Downloading {pct} percent": "Downloading {pct} percent",
  "Checking file…": "Checking file…",
  "File unavailable": "File unavailable",
  "The catalog could not be refreshed.": "The catalog could not be refreshed.",
  "The Cinemeta catalog could not be refreshed.": "The Cinemeta catalog could not be refreshed.",
  "The Cinemeta catalog returned an invalid response.":
    "The Cinemeta catalog returned an invalid response.",
  "An addon manifest could not be refreshed.": "An addon manifest could not be refreshed.",
  "An addon catalog could not be refreshed.": "An addon catalog could not be refreshed.",
  "An addon catalog returned an invalid response.":
    "An addon catalog returned an invalid response.",
  "The Home hero feed could not be refreshed.": "The Home hero feed could not be refreshed.",
  "Refresh library": "Refresh library",
  "Refresh watchlist": "Refresh watchlist",
  "Home is not ready to refresh.": "Home is not ready to refresh.",
  "This profile changed before its refresh completed.":
    "This profile changed before its refresh completed.",
  "This library changed before its refresh completed.":
    "This library changed before its refresh completed.",
  "This history changed before its refresh completed.":
    "This history changed before its refresh completed.",
  "This playlist changed before its refresh completed.":
    "This playlist changed before its refresh completed.",
  "This playlist is no longer available.": "This playlist is no longer available.",
  "History could not be refreshed.": "History could not be refreshed.",
  ...
  "Download now": "Download now",
  "Disable auto-download for new episodes": "Disable auto-download for new episodes",
  "Choose an episode or season, then choose a source.":
    "Choose an episode or season, then choose a source.",
  "Loading episodes…": "Loading episodes…",
  "Could not load episodes. Try again.": "Could not load episodes. Try again.",
  "No episodes available from this title’s providers.":
    "No episodes available from this title’s providers.",
  "Not released": "Not released",
  "In downloads": "In downloads",
  "Could not save automatic download settings. Your previous settings were kept.":
    "Could not save automatic download settings. Your previous settings were kept.",
  "Disable automatic downloads for {title}": "Disable automatic downloads for {title}",
  "Disable automatic downloads": "Disable automatic downloads",
  "Automatic downloads enabled": "Automatic downloads enabled",
  "Enabled for newly released episodes.": "Enabled for newly released episodes.",
  "Enabled for newly released episodes": "Enabled for newly released episodes",
  "Delete file": "Delete file",
  "Delete post": "Delete post",
  "Lists unavailable": "Lists unavailable",
  "Collections unavailable": "Collections unavailable",
  ...
  "Could not write the file. Choose a writable folder and check available space.":
    "Could not write the file. Choose a writable folder and check available space.",
  "Could not open the file save dialog. Try again.":
    "Could not open the file save dialog. Try again.",
  "Refresh Home": "Refresh Home",
  "Refresh Discover": "Refresh Discover",
  "Refresh collections": "Refresh collections",
  "Refresh profile": "Refresh profile",
  "This page changed before its refresh completed.":
    "This page changed before its refresh completed.",
  ...
  "Delete files ({count})": "Delete files ({count})",
  "{count} downloads. Partial files are kept.": "{count} downloads. Partial files are kept.",
  "{count} print records; no saved PDF files.": "{count} print records; no saved PDF files.",
  "{count} files · {scope}": "{count} files · {scope}",
  Details: "Details",
  "Hide details": "Hide details",
  "Could not complete this action.": "Could not complete this action.",
  "This is not home-server playback.": "This is not home-server playback.",
  "This home-server copy is no longer available.": "This home-server copy is no longer available.",
  "Open the menu again to continue playback.": "Open the menu again to continue playback.",
  "Playback continuation is already opening.": "Playback continuation is already opening.",
  "Local playback requires the Harbor desktop application.":
    "Local playback requires the Harbor desktop application.",
  "The last video file could not be accessed.": "The last video file could not be accessed.",
  "Last playback changed. Open the menu again.": "Last playback changed. Open the menu again.",
  "This playback has finished. Choose Play from beginning to restart it.":
    "This playback has finished. Choose Play from beginning to restart it.",
  "Another playback is active. Return to the player first.":
    "Another playback is active. Return to the player first.",
  "The last video file is missing or unavailable.":
    "The last video file is missing or unavailable.",
  "The last playback source is no longer available.":
    "The last playback source is no longer available.",
  "Playback changed. Open the menu again.": "Playback changed. Open the menu again.",
