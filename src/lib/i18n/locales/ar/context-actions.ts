const contextActions: Record<string, string> = {
  "Download chapters": "تنزيل الفصول",
  "Read chapter": "قراءة الفصل",
  "Manga download failed": "تعذّر تنزيل فصل المانجا",
  "Manga source is no longer available": "لم يعد مصدر المانجا متاحًا",
  "Copy magnet": "نسخ رابط المغناطيس",
  "Select a subtitle track first.": "اختر مسار ترجمة أولًا.",
  "This Continue Watching entry is no longer available.": "عنصر متابعة المشاهدة هذا لم يعد متاحًا.",
  "This episode has not aired yet.": "لم تُعرض هذه الحلقة بعد.",
  "Removed on this device. Stremio synchronization is pending.":
    "تمت الإزالة على هذا الجهاز. مزامنة Stremio قيد الانتظار.",
  "Removed from Continue Watching, but the saved position could not be cleared.":
    "تمت الإزالة من متابعة المشاهدة، لكن تعذّر مسح موضع التشغيل المحفوظ.",
  "Removed from Continue Watching on this device, but synchronization could not be saved.":
    "تمت الإزالة من متابعة المشاهدة على هذا الجهاز، لكن تعذّر حفظ طلب المزامنة.",
  "Playback finished": "انتهى التشغيل",
  "Play this same video from the beginning?": "تشغيل الفيديو نفسه من البداية؟",
  "Opening playback…": "جارٍ فتح التشغيل…",
  "Continue last watched": "متابعة آخر مشاهدة",
  "Local video": "فيديو محلي",
  "Open my profile": "فتح ملفي الشخصي",
  "Add to page": "إضافة إلى صفحة",
  "Download…": "تنزيل…",
  "Choose a source to download this movie.": "اختر مصدرًا لتنزيل هذا الفيلم.",
  "Choose source": "اختيار المصدر",
  "Downloading {pct} percent": "جارٍ التنزيل، {pct} بالمئة",
  "Checking file…": "جارٍ التحقق من الملف…",
  "File unavailable": "الملف غير متاح",
  "The catalog could not be refreshed.": "تعذّر تحديث الكتالوج.",
  "The Cinemeta catalog could not be refreshed.": "تعذّر تحديث كتالوج Cinemeta.",
  "The Cinemeta catalog returned an invalid response.": "أعاد كتالوج Cinemeta استجابة غير صالحة.",
  "An addon manifest could not be refreshed.": "تعذّر تحديث معلومات إحدى الإضافات.",
  "An addon catalog could not be refreshed.": "تعذّر تحديث كتالوج إحدى الإضافات.",
  "An addon catalog returned an invalid response.": "أعاد كتالوج إحدى الإضافات استجابة غير صالحة.",
  "The Home hero feed could not be refreshed.":
    "تعذّر تحديث محتوى العرض الرئيسي في الصفحة الرئيسية.",
  "Refresh library": "تحديث المكتبة",
  "Refresh watchlist": "تحديث قائمة المشاهدة",
  "Home is not ready to refresh.": "الصفحة الرئيسية غير جاهزة للتحديث.",
  "This profile changed before its refresh completed.": "تغيّر البروفايل قبل اكتمال تحديثه.",
  "This library changed before its refresh completed.": "تغيّرت المكتبة قبل اكتمال تحديثها.",
  "This history changed before its refresh completed.": "تغيّر السجل قبل اكتمال تحديثه.",
  "This playlist changed before its refresh completed.": "تغيّرت قائمة التشغيل قبل اكتمال تحديثها.",
  "This playlist is no longer available.": "قائمة التشغيل هذه لم تعد متاحة.",
  "History could not be refreshed.": "تعذّر تحديث السجل.",
  "Some Home content could not be refreshed. Existing content has been kept where possible.":
    "تعذّر تحديث بعض محتوى الصفحة الرئيسية. تم الاحتفاظ بالمحتوى الموجود حيث أمكن.",
  "Some profile content could not be refreshed. Existing content has been kept where possible.":
    "تعذّر تحديث بعض محتوى البروفايل. تم الاحتفاظ بالمحتوى الموجود حيث أمكن.",
  "Some library content could not be refreshed. Existing content has been kept where possible.":
    "تعذّر تحديث بعض محتوى المكتبة. تم الاحتفاظ بالمحتوى الموجود حيث أمكن.",
  "Some history could not be refreshed. Existing history has been kept where possible.":
    "تعذّر تحديث بعض السجل. تم الاحتفاظ بالسجل الموجود حيث أمكن.",
  "Download now…": "تنزيل الآن…",
  "Download now": "تنزيل الآن",
  "Disable auto-download for new episodes": "إيقاف التنزيل التلقائي للحلقات الجديدة",
  "Choose an episode or season, then choose a source.": "اختر حلقة أو موسمًا، ثم اختر مصدر التنزيل.",
  "Loading episodes…": "جارٍ تحميل الحلقات…",
  "Could not load episodes. Try again.": "تعذّر تحميل الحلقات. حاول مرة أخرى.",
  "No episodes available from this title’s providers.": "لا توجد حلقات متاحة لدى مزوّدي هذا العمل.",
  "Not released": "لم تصدر بعد",
  "In downloads": "ضمن التنزيلات",
  "Could not save automatic download settings. Your previous settings were kept.":
    "تعذّر حفظ إعدادات التنزيل التلقائي. تم الاحتفاظ بإعداداتك السابقة.",
  "Disable automatic downloads for {title}": "إيقاف التنزيل التلقائي لـ {title}",
  "Disable automatic downloads": "إيقاف التنزيل التلقائي",
  "Automatic downloads enabled": "التنزيل التلقائي مفعّل",
  "Enabled for newly released episodes.": "مفعّل للحلقات التي تصدر حديثًا.",
  "Enabled for newly released episodes": "مفعّل للحلقات التي تصدر حديثًا",
  "Delete file": "حذف الملف",
  "Delete post": "حذف المنشور",
  "Lists unavailable": "القوائم غير متاحة",
  "Collections unavailable": "الكولكشنات غير متاحة",
  "Your session could not be renewed. Sign in again and retry.":
    "تعذّر تجديد جلستك. سجّل الدخول مجددًا ثم أعد المحاولة.",
  "You do not have permission to make this change.": "ليس لديك صلاحية لإجراء هذا التغيير.",
  "Friend removed": "تمت إزالة الصديق",
  "The relationship update could not be confirmed. Refresh its current state.":
    "تعذّر تأكيد تحديث العلاقة. حدّث حالتها الحالية.",
  "Delete the comment by @{handle}? This cannot be undone.":
    "هل تريد حذف تعليق @{handle}؟ لا يمكن التراجع عن ذلك.",
  "Comment deleted": "تم حذف التعليق",
  "This download's file scope has changed. Review the action again.":
    "تغيّر الملف المرتبط بهذا التنزيل. راجع الإجراء مجددًا.",
  "The post deletion could not be confirmed. Refresh its current state.":
    "تعذّر تأكيد حذف المنشور. حدّث حالته الحالية.",
  "Confirm cancellation": "تأكيد الإلغاء",
  "Cancelling…": "جارٍ الإلغاء…",
  "Removing…": "جارٍ الإزالة…",
  "Post deleted": "تم حذف المنشور",
  "This test build saves only inside its isolated downloads folder. Keep the folder initially selected in the save dialog.":
    "تحفظ نسخة الاختبار هذه داخل مجلد تنزيلاتها المعزول فقط. احتفظ بالمجلد المحدد أولًا في نافذة الحفظ.",
  "Could not write the file. Choose a writable folder and check available space.":
    "تعذّرت كتابة الملف. اختر مجلدًا يمكن الكتابة فيه وتحقق من المساحة المتاحة.",
  "Could not open the file save dialog. Try again.": "تعذّر فتح نافذة حفظ الملف. حاول مرة أخرى.",
  "Refresh Home": "تحديث الرئيسية",
  "Refresh Discover": "تحديث الاستكشاف",
  "Refresh collections": "تحديث الكولكشنات",
  "Refresh profile": "تحديث البروفايل",
  "This page changed before its refresh completed.": "تغيّرت الصفحة قبل اكتمال تحديثها.",
  "Some Discover content could not be refreshed. Existing content has been kept where possible.":
    "تعذّر تحديث بعض محتوى الاستكشاف. تم الاحتفاظ بالمحتوى الموجود حيث أمكن.",
  "Copy Text": "نسخ النص",
  "Open image link": "فتح رابط الصورة",
  "Search destinations": "البحث عن وجهة",
  ...
  "Add to": "إضافة إلى",
  Lists: "القوائم",
  Collections: "الكولكشنات",
  "Delete files ({count})": "حذف الملفات ({count})",
  "{count} downloads. Partial files are kept.": "{count} تنزيلات. ستبقى الملفات الجزئية.",
  "{count} print records; no saved PDF files.": "{count} سجلات طباعة؛ لا توجد ملفات PDF محفوظة.",
  "{count} files · {scope}": "{count} ملفات · {scope}",
  Details: "التفاصيل",
  "Hide details": "إخفاء التفاصيل",
  "Could not complete this action.": "تعذّر إكمال هذا الإجراء.",
  "This is not home-server playback.": "هذا التشغيل ليس من خادم منزلي.",
  "This home-server copy is no longer available.": "لم تعد هذه النسخة متاحة على الخادم المنزلي.",
  "Open the menu again to continue playback.": "افتح القائمة مجددًا لاستئناف المشاهدة.",
  "Playback continuation is already opening.": "يجري فتح آخر مشاهدة بالفعل.",
  "Local playback requires the Harbor desktop application.":
    "يتطلب تشغيل الملفات المحلية تطبيق Harbor لسطح المكتب.",
  "The last video file could not be accessed.": "تعذّر الوصول إلى ملف الفيديو الأخير.",
  "Last playback changed. Open the menu again.": "تغيّرت آخر مشاهدة. افتح القائمة مجددًا.",
  "This playback has finished. Choose Play from beginning to restart it.":
    "انتهى هذا الفيديو. اختر «تشغيل من البداية» لإعادته.",
  "Another playback is active. Return to the player first.":
    "هناك فيديو آخر قيد التشغيل. عُد إلى المشغّل أولًا.",
  "The last video file is missing or unavailable.": "ملف الفيديو الأخير مفقود أو غير متاح.",
  "The last playback source is no longer available.": "لم يعد مصدر آخر مشاهدة متاحًا.",
  "Playback changed. Open the menu again.": "تغيّر التشغيل. افتح القائمة مجددًا.",
  "Playback controls are not available in this session.":
    "أدوات التحكم بالتشغيل غير متاحة في هذه الجلسة.",
};
