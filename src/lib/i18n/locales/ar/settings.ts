const settings: Record<string, string> = {
  ...
  "Updates": "التحديثات",
  "Harbor checks your configured updates server for new versions and installs them in place.": "يتحقق Harbor من خادم التحديثات المخصص من إصدارات جديدة ويثبّتها في مكانها.",
  ...
  "About": "حول",
  "Build identity. Useful when troubleshooting issues or filing bug reports.": "معلومات البناء. مفيدة عند حل المشكلات أو تقديم تقارير الأخطاء.",
  ...
  "Harbor checks your configured updates server for new versions and installs them in place. Nothing installs until you choose to, and a dismissed update never nags you again.": "يتحقق Harbor من خادم التحديثات للبحث عن إصدارات جديدة ويثبتها في مكانها. لا يتم تثبيت أي شيء حتى تختار ذلك، ولن يزعجك إشعار التحديث المرفوض مرة أخرى.",
  ...
  "Checking your configured updates server for a newer build.": "يتحقّق من خادم التحديثات بحثًا عن إصدار أحدث.",
