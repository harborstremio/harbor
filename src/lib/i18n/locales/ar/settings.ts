const settings: Record<string, string> = {
  ...
  "If a stream or the video player misbehaves, export the player log and attach it above. It saves to your Downloads folder.":
    "إذا تعثّر البث أو المشغّل، صدّر سجل المشغّل وأرفقه أعلاه. يُحفظ في مجلد التنزيلات.",
  "Saved to Downloads as harbor-mpv-log.txt": "حُفظ في التنزيلات باسم harbor-mpv-log.txt",
  "Saved to {path}": "حُفظ في {path}",
  "No player log yet. Play something first, then export.": "لا يوجد سجل بعد. شغّل فيديو أولًا ثم صدّر.",
  "Player log export only works in the desktop app.": "تصدير سجل المشغّل يعمل فقط في تطبيق سطح المكتب.",
  "PNG, JPG, WebP, GIF, MP4, WebM, MOV. Up to {n} files, 100 MB each.":
    "PNG و JPG و WebP و GIF و MP4 و WebM و MOV. حتى {n} ملفات، 100 ميجابايت لكل ملف.",
  "Max {n} files.": "الحد الأقصى {n} ملفات.",
  "{name} is over 100 MB.": "{name} أكبر من 100 ميجابايت.",
  "{name} is not an image or video.": "{name} ليس صورة أو فيديو.",
  "Could not reach the bug report server. Check your connection.": "تعذّر الوصول لخادم البلاغات. تحقّق من الاتصال.",
