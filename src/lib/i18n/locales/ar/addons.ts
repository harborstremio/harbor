const addons: Record<string, string> = {
  ...
  "Off · catalogs and streams hidden": "متوقّفة · الكتالوج والبث مخفيان",
  Enabled: "مُفعّلة",
  Disabled: "مُعطّلة",
  ...
  "Six places to start. Tap one and we'll filter the catalog for you.":
    "ستّة أماكن للبدء. اضغط واحدًا وسنُصفّي الكتالوج لك.",
  Streaming: "البث",
  ...
  "Stremio addon, packaged into Harbor's catalog.": "إضافة Stremio ضمن كتالوج Harbor.",
  ...
  "Catalogs & metadata": "الكتالوج والبيانات الوصفية",
  Streams: "البثوث",
  Sports: "الرياضة",
  Tools: "الأدوات",
