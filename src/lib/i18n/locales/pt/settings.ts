const settings: Record<string, string> = {
  ...
  "Harbor checks your configured updates server for new versions and installs them in place.": "O Harbor verifica o servidor de atualizações configurado em busca de novas versões e as instala no local.",
  ...
  "About": "Sobre",
  "Build identity. Useful when troubleshooting issues or filing bug reports.": "Identidade da build. Útil na resolução de problemas ou relato de bugs.",
  ...
  "Harbor checks your configured updates server for new versions and installs them in place. Nothing installs until you choose to, and a dismissed update never nags you again.": "O Harbor verifica o servidor de atualizações configurado em busca de novas versões e as instala no local. Nada é instalado até você decidir, e uma atualização dispensada nunca mais incomoda.",
  ...
  "Checking your configured updates server for a newer build.": "Verificando o servidor de atualizações em busca de uma build mais recente.",
