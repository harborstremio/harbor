...
export const setLocalWatchlistMembership = store.setExternalSafely;
export const readLocalWatchlistMembership = store.readExternalMembership;
export const subscribeLocalWatchlist = store.subscribeExternal;
