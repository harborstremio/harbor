...
export const HOTKEYS: HotkeyDef[] = [
  ...
  },
  {
    ...
    group: "Playback",
    label: "Record GIF",
    description: "Start or stop recording a GIF of the video (no subtitles). Saves to Pictures/Harbor.",
    defaultBinding: "o",
  },
  {
    id: "playerClipRecord",
...
export const HOTKEY_MAP: Record<HotkeyId, HotkeyDef> = Object.fromEntries(HOTKEYS.map((h) => [h.id, h])) as Record<
  HotkeyId,
  HotkeyDef
>;
