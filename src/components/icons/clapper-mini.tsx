export function ClapperMini({ size = 12 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 14 14" fill="none" aria-hidden style={{ overflow: "visible" }}>
      <rect x="1.4" y="6.4" width="11.2" height="6" rx="0.9" fill="currentColor" fillOpacity="0.95" />
      <g
        style={{
