...
const QUESTION_BANK: Question[] = [
  ...
  },
  {
    ...
    options: ["The hourly rate", "What lands in your bank", "Just the bonus portion", "The same as gross"],
    correct: 1,
  },
  {
  ...
  },
  {
    ...
    options: ["Receipts for expenses", "Hours you worked this week", "Your holiday plans", "A complaint to HR"],
    correct: 1,
  },
  {
...
const AR_QUESTION_BANK: Question[] = [
  ...
  },
  {
    ...
    options: ["دفع آخر شهر إيجار مسبقًا", "ضريبة تسجيل العقار", "تغطية الأضرار عند المغادرة", "رسوم لوكالة العقار"],
    correct: 2,
  },
  {
    q: 'حسابك البنكي أصبح "بالسالب". ماذا حدث؟',
    options: ["كسبت فائدة فوق الحد المسموح", "أنفقت أكثر من رصيدك", "وصلت لحد المدخرات", "أوقف البنك حسابك"],
    correct: 1,
  },
  {
  ...
  },
  {
    ...
    options: ["فرض رسوم مرة واحدة فقط", "سحب المبلغ وفق جدول زمني", "عكس المعاملات القديمة", "تحويل عملتك"],
    correct: 1,
  },
  {
    q: "الرهن العقاري هو في الأساس:",
    options: ["تأمين يغطّي المنزل", "قرض مرتبط بالعقار", "اتفاق بين المالك والمستأجر", "فاتورة ضريبة عقارية سنوية"],
    correct: 1,
  },
  {
  ...
  },
  {
    ...
    options: ["الناتج المحلي ينكمش", "الأسعار ترتفع بشكل عام", "العملة تكتسب قوة", "البطالة ترتفع"],
    correct: 1,
  },
  {
    q: 'وثيقة تحتاج إلى "التوثيق". تأخذها لشخص سيقوم بـ:',
    options: ["ترجمتها إلى لغة أخرى", "التحقق منها وشهادة التوقيع", "تقديمها للحكومة", "تطبيقها قانونيًا"],
    correct: 1,
  },
  {
  ...
  },
  {
    ...
    options: ["الحصول على أكبر حصة", "تسوية شؤون التركة", "الشهادة على التوقيع فقط", "الموافقة على الوصية في المحكمة"],
    correct: 1,
  },
  {
    q: 'قسيمة راتبك تُظهر الراتب "الإجمالي" و"الصافي". الصافي هو:',
    options: ["الأجر بالساعة", "ما يصل إلى حسابك البنكي", "جزء المكافأة فقط", "نفس الإجمالي"],
    correct: 1,
  },
  {
  ...
  },
  {
    ...
    options: ["عدد أشهر القرض", "تكلفة الاقتراض سنويًا", "أرباح البنك الفصلية", "الرسوم الإجمالية بمبلغ ثابت"],
    correct: 1,
  },
  {
    q: 'رسوم في تطبيق بنكك بحالة "معلّق" ليوم. التاجر:',
    options: ["يعيدها إليك", "يحجز الأموال قبل التسوية", "سيفرض ضعفها الأسبوع القادم", "يرفض المعاملة"],
    correct: 1,
  },
  {
    q: 'مديرك يقول "أرسل كشف ساعاتك بحلول الجمعة". أنت تسجّل:',
    options: ["إيصالات المصاريف", "الساعات التي عملتها هذا الأسبوع", "خطط إجازتك", "شكوى لقسم الموارد البشرية"],
    correct: 1,
  },
  {
  ...
  },
  {
    ...
    options: ["يتوقف حتى تعيد تفعيله", "يُفوترك لفترة أخرى", "ينخفض سعره للنصف", "يُلغى ويُسترد المبلغ"],
    correct: 1,
  },
  {
    q: 'عرض عمل راتبه "تنافسي". هذا يخبرك:',
    options: ["ستتنافس مع أقرانك للحصول عليه", "يتوافق بشكل عام مع السوق", "يتغير كل ربع سنة", "هو عمولة فقط"],
    correct: 1,
  },
  {
    q: 'تقدّمت بإقرار ضريبي كـ "صاحب عمل حر". تدفع ضريبة على:',
    options: ["المبالغ التي سحبتها فقط", "أرباح عملك", "إجمالي الإيرادات", "ما هو في حسابك البنكي"],
    correct: 1,
  },
];
...
export function AgeGateModal({ open, onClose, onPass }: { open: boolean; onClose: () => void; onPass: () => void }) {
  const t = useT();
  const isAr = useUiLanguage() === "ar";
  const [seed, setSeed] = useState(() => Date.now() % 1_000_000);
  const questions = useMemo(() => pickThree(seed, isAr ? AR_QUESTION_BANK : QUESTION_BANK), [seed, isAr]);
              ...
              <div className="flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  className={`whitespace-nowrap rounded-full px-6 py-2 text-[12.5px] font-semibold leading-none transition-opacity ${
                    allAnswered ? "bg-ink text-canvas hover:opacity-90" : "cursor-not-allowed bg-edge text-ink-subtle"
                  }`}
                >
                  {t("Continue")}
                </button>
