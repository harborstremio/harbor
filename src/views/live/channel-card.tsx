...
import { Info, Pin, Tv, Play, PinOff } from "lucide-react";
...
export function ChannelCard({
  ...
  const contextRef = useContextTarget<HTMLDivElement>(() => ({
    ...
    actions: () => [
      ...
      {
        id: "channel:pin",
        icon: isChannelPinned ? <PinOff size={16} /> : <Pin size={16} />,
        active: isChannelPinned,
        label: isChannelPinned ? t("Unpin channel") : t("Pin channel"),
        run: () => {
