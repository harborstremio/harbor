    ...
    <>
      ...
      {isTauri && (
        <Section
          title={t("Updates")}
          subtitle={t(
            "Harbor checks your configured updates server for new versions and installs them in place. Nothing installs until you choose to, and a dismissed update never nags you again.",
          )}
        >
    ...
    <section className="relative overflow-hidden rounded-2xl border border-edge bg-elevated/60 p-7">
      ...
      <div className="relative z-10 flex max-w-[54%] flex-col gap-3">
        ...
        <p className="text-[13.5px] leading-relaxed text-ink-muted">
          {t(
            "Everything you save here stays in this browser. Your Stremio login, API keys, watch progress, picker cache, dismissed tips. External servers never see any of it. Clearing your browser data wipes it.",
          )}
        </p>
        <p className="text-[13.5px] leading-relaxed text-ink-muted">
          {t(
