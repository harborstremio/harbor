      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {top.map((a, i) => {
          ...
          const card = (
            ...
            >
              <span className="w-5 shrink-0 text-center text-[15.5px] font-bold tabular-nums text-ink-subtle">
                {i + 1}
              </span>
              {a.avatar ? (
                <img
                ...
                <span
                  className="grid h-11 w-11 shrink-0 place-items-center rounded-full text-[15.5px] font-bold text-white ring-1 ring-white/15"
                ...
                <span className="flex min-w-0 items-baseline gap-1.5">
                  {h ? (
                    <span
                      ...
                      className="truncate cursor-pointer text-[16.5px] font-medium leading-[24px] tracking-[-0.1px] text-ink underline-offset-2 outline-none hover:text-accent hover:underline focus-visible:text-accent focus-visible:underline"
                    >
                  ...
                  {h && (
                    <span className="shrink-0 truncate font-display text-[15.5px] leading-[22px] text-ink-subtle">
                      @{h}
                    </span>
                  )}
                </span>
