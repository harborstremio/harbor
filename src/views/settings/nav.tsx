...
const IconBase = ({ size = 20, strokeWidth = 1.7, children }: IconProps & { children: React.ReactNode }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const NAV_GROUPS: Array<{ heading: string | null; items: NavItem[] }> = [
  ...
  {
    heading: "Help",
    items: [{ id: "bug", label: "Report a bug", Icon: IconBug, keywords: ["report", "feedback", "issue", "crash"] }],
  },
  {
    heading: "System",
    items: [
...
const SETTINGS_OPTIONS: SettingsOption[] = [
  ...
  },
  {
    ...
    keywords: ["poster size", "card size", "compact", "default", "large", "huge", "scale", "grid", "bigger posters"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["trailer", "trailer quality", "youtube", "ytdl", "ytdlp", "360p", "720p", "1080p", "best"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["hide watched", "hide finished", "watched filter", "catalog filter", "trakt history", "seen"],
  },
  {
    label: "Downloads folder",
    section: "advanced",
    anchorTitle: "Downloads",
    keywords: ["downloads", "download folder", "location", "directory", "save", "path", "choose folder", "open folder"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["internet speed", "bandwidth", "cap", "limit", "mbps", "gbps", "speed test", "fiber", "gigabit", "data"],
  },
  {
    label: "Remember last stream",
    section: "player",
    anchorTitle: "Remember last stream",
    keywords: ["remember last stream", "resume stream", "last source", "addon memory", "source memory"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["hardware acceleration", "hwdec", "gpu decoding", "graphics card", "cpu", "decode", "battery"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["continue watching", "screenshots", "snapshots", "frames", "retention", "clear frames", "storage"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["content filters", "hide anime", "hide live tv", "hide sports", "hide adult", "age", "filter"],
  },
  ...
  },
  {
    ...
    keywords: ["preferred languages", "rank", "priority", "only show my languages", "filter streams", "multi-audio"],
  },
  ...
  },
  {
    ...
    keywords: ["background", "wallpaper", "image", "choose image", "replace", "remove", "dim overlay"],
  },
  {
...

  {
    ...
    section: "trakt",
    keywords: ["trakt", "scrobble", "sync", "watchlist", "connect", "disconnect", "avatar", "history"],
  },
  {
  ...
  },
  {
    ...
    section: "webhooks",
    keywords: ["webhooks", "discord", "telegram", "notifications", "alerts", "calendar sources", "rules", "upcoming"],
  },
  {
  ...
  },
  {
    ...
    section: "basics",
    keywords: ["debrid", "real-debrid", "torbox", "alldebrid", "instant hd", "quality", "set up", "sources"],
  },
  {
  ...
  },
  {
    ...
    section: "account",
    anchorTitle: "Harbor identity",
    keywords: ["display name", "nickname", "rename", "edit name", "watch together name", "identity", "profile"],
  },
  {
    label: "Upload photo",
    section: "account",
  ...
  },
  {
    ...
    section: "account",
    anchorTitle: "Harbor identity",
    keywords: ["avatar catalog", "built-in avatars", "browse avatars", "picker", "characters", "netflix style"],
  },
  {
    label: "Random avatar",
    section: "account",
  ...
  },
  {
    ...
    section: "account",
    anchorTitle: "Harbor identity",
    keywords: ["color", "cursor color", "chat color", "name pill", "custom color", "hex picker", "swatch"],
  },
  {
  ...
  },
  {
    ...
    section: "library",
    anchorTitle: "Home layout",
    keywords: ["addon rows", "duplicate rows", "dedup", "merged rails", "show all rows", "catalogs"],
  },
  {
    label: "Watchlist shows only saved titles",
    section: "library",
    anchorTitle: "Home layout",
    keywords: ["watchlist", "bookmarked only", "saved titles", "library tab", "auto added", "stremio saves"],
  },
  {
  ...
  },
  {
    ...
    section: "library",
    anchorTitle: "Home layout",
    keywords: ["continue watching", "next episode", "advance", "auto next", "cw card", "zero minutes"],
  },
  {
  ...
  },
  {
    ...
    section: "library",
    anchorTitle: "Episode cards",
    keywords: ["hd images", "full resolution", "episode artwork", "bandwidth", "slow connection", "w300"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["song id", "shazam", "audd", "music recognition", "identify song", "now playing", "what song"],
  },
  {
    label: "Now Playing card",
    section: "library",
    anchorTitle: "Now Playing card",
    keywords: ["song card", "compact", "cinematic", "music card", "disc", "cover style", "card style"],
  },
  {
  ...
  },
  {
    ...
    section: "library",
    anchorTitle: "Continue Watching screenshots",
    keywords: ["snapshot retention", "saved frames", "1 week", "30 days", "1 year", "none", "screenshots"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["ai search", "openrouter", "api key", "ask ai", "natural language", "smart search", "sk-or"],
  },
  {
    label: "Model",
    section: "library",
    anchorTitle: "AI search",
    keywords: ["ai model", "gpt", "claude", "gemini", "llama", "deepseek", "mistral", "choose model"],
  },
  {
    label: "TMDB · catalogs and rails",
    section: "library",
    anchorTitle: "Metadata providers",
    keywords: ["tmdb", "api key", "v3 key", "themoviedb", "catalogs", "trending", "how to get this", "guide"],
  },
  {
  ...
  },
  {
    ...
    section: "library",
    anchorTitle: "Metadata providers",
    keywords: ["poster server", "better posters", "btttr", "postersplus", "url template", "custom posters", "imdbid"],
  },
  {
  ...
  },
  {
    ...
    section: "library",
    anchorTitle: "Metadata providers",
    keywords: ["meta addon", "localized cinemeta", "custom metadata", "override cinemeta", "descriptions"],
  },
  {
  ...
  },
  {
    ...
    section: "library",
    anchorTitle: "Metadata providers",
    keywords: ["tvdb", "thetvdb", "episode titles", "network info", "subscriber key", "alternate names"],
  },
  {
  ...
  },
  {
    ...
    section: "library",
    anchorTitle: "Metadata providers",
    keywords: ["hover preview", "peek", "poster hover", "current", "elegant", "preview style", "popup card"],
  },
  {
    label: "Hover style",
    section: "library",
  ...
  },
  {
    ...
    section: "library",
    anchorTitle: "Metadata providers",
    keywords: ["mark watched", "watched button", "detail page", "trakt sync", "simkl sync", "check"],
  },
  {
  ...
  },
  {
    ...
    section: "trakt",
    keywords: ["import watchlist", "pull watchlist", "trakt to harbor", "download", "move watchlist"],
  },
  {
  ...
  },
  {
    ...
    section: "trakt",
    keywords: ["blur comments by default", "blur comments", "spoiler comments", "hide reviews", "reveal"],
  },
  {
  ...
  },
  {
    ...
    section: "anilist",
    keywords: ["blur comments by default", "blur comments", "spoilers", "hide comments", "reveal", "anime pages"],
  },
  {
  ...
  },
  {
    ...
    section: "mal",
    keywords: ["mal", "myanimelist", "connect", "anime lists", "link account", "anime tracking", "oauth"],
  },
  {
    label: "MAL Client ID",
    section: "mal",
  ...
  { label: "About MyAnimeList", section: "mal", keywords: ["myanimelist.net", "info", "website", "what is mal"] },
  {
    ...
    section: "mal",
    keywords: ["open profile", "mal profile", "view profile", "profile page", "myanimelist profile"],
  },
  {
  ...
  },
  {
    ...
    section: "letterboxd",
    keywords: ["watchlist", "diary", "liked films", "friends", "recommended for you", "popular this week", "top 250"],
  },
  {
    label: "Custom lists",
    section: "letterboxd",
  ...
  },
  {
    ...
    section: "relay",
    anchorTitle: "Harbor Relay",
    keywords: ["relay", "watch together", "cloudflare worker", "rooms", "sync server", "copy url", "hosted relay"],
  },
  {
  ...
  },
  {
    ...
    section: "streaming",
    anchorTitle: "Picker layout",
    keywords: ["condensed", "stremio layout", "picker style", "flat list", "quality tiles", "drawer", "source list"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["full description", "aiostreams", "stream info", "trim", "tidier rows", "addon description"],
  },
  {
  ...
  },
  {
    ...
    section: "streaming",
    anchorTitle: "Result order",
    keywords: ["harbor ranking", "addon order", "sort results", "priority", "ordering", "best first", "vidi"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["custom filters", "saved filters", "filter builder", "source picker", "named filter", "your filters"],
  },
  {
    label: "New filter",
    section: "streamFilters",
  ...
  },
  {
    ...
    section: "p2p",
    anchorTitle: "Local engine",
    keywords: ["torrent engine", "p2p engine", "built-in engine", "status", "port", "dht", "active torrents", "nodes"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["cache retention", "1 day", "3 days", "1 week", "forever", "off", "resume instantly"],
  },
  {
    label: "Keep at most",
    section: "p2p",
    anchorTitle: "Stream cache",
    keywords: ["cache limit", "disk space", "10 gb", "100 gb", "unlimited", "cap", "oldest deleted"],
  },
  {
  ...
  },
  {
    ...
    section: "p2p",
    anchorTitle: "Stream cache",
    keywords: ["cache folder", "directory", "change location", "reset location", "disk", "move cache"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["direct torrent", "p2p streaming", "no debrid", "uncached", "peers", "own connection"],
  },
  {
  ...
  },
  {
    ...
    section: "p2p",
    anchorTitle: "Your streaming server address",
    keywords: ["start server", "stop server", "restart server", "streaming server", "stremio server", "antivirus"],
  },
  {
  ...
  },
  {
    ...
    section: "p2p",
    anchorTitle: "Remote streaming server",
    keywords: ["test connection", "run test", "probe", "reachable", "ping server", "settings endpoint"],
  },
  {
    label: "Forget",
    section: "p2p",
  ...
  },
  {
    ...
    section: "language",
    anchorTitle: "Subtitle languages",
    keywords: ["subtitles off", "disable subtitles", "no subs", "captions off", "dont show subtitles", "default off"],
  },
  {
  ...
  },
  {
    ...
    section: "language",
    anchorTitle: "Subtitle languages",
    keywords: ["forced subtitles", "signs only", "foreign dialogue", "forced track", "native audio", "partial subs"],
  },
  {
    label: "Upgrade subtitles when better ones load",
    section: "language",
    anchorTitle: "Subtitle languages",
    keywords: ["subtitle upgrade", "auto switch subtitles", "better match", "late loading subs", "swap subtitles"],
  },
  {
    label: "Never auto-select tracks containing",
    section: "language",
    anchorTitle: "Subtitle languages",
    keywords: ["block words", "commentary", "descriptive", "sdh", "track filter", "blacklist", "skip tracks"],
  },
  {
    label: "Background",
    section: "language",
    anchorTitle: "Subtitle style",
    keywords: ["drop shadow", "outline", "black bar", "box", "subtitle background", "halo", "stroke"],
  },
  {
  ...
  },
  {
    ...
    section: "language",
    anchorTitle: "Subtitle style",
    keywords: ["subtitle font", "inter", "system font", "serif", "arabic font", "typeface", "rounded"],
  },
  {
    label: "Upload font",
    section: "language",
  ...
  },
  {
    ...
    section: "language",
    anchorTitle: "Subtitle style",
    keywords: ["pip subtitles", "picture in picture captions", "floating window subs", "mini player subtitles"],
  },
  {
    label: "Subtitle size",
    section: "language",
  ...
  },
  {
    ...
    section: "language",
    anchorTitle: "Subtitle style",
    keywords: ["subtitle position", "raise subtitles", "vertical margin", "height from bottom", "move subtitles up"],
  },
  {
    label: "Alignment",
    section: "language",
    anchorTitle: "Subtitle style",
    keywords: ["left", "center", "right", "subtitle alignment", "justify text", "horizontal position"],
  },
  {
    label: "Text color",
    section: "language",
  ...
  },
  {
    ...
    section: "language",
    anchorTitle: "Subtitle style",
    keywords: ["reset to defaults", "reset subtitle style", "default look", "undo changes", "factory subtitles"],
  },
  {
  ...
  },
  {
    ...
    section: "language",
    anchorTitle: "Metadata language",
    keywords: ["translated plot", "descriptions", "taglines", "synopsis translation", "overview language"],
  },
  {
    label: "Only show streams in my languages",
    section: "language",
    anchorTitle: "Preferred languages",
    keywords: ["hide other languages", "language filter", "only my language", "strict filter", "drop foreign streams"],
  },
  {
  ...
  },
  {
    ...
    section: "player",
    anchorTitle: "Play button behavior",
    keywords: ["instant play", "auto pick stream", "best stream", "one click play", "jump into playback"],
  },
  {
    label: "Manual picker",
    section: "player",
    anchorTitle: "Play button behavior",
    keywords: ["source list", "stream picker", "choose quality", "pick source", "debrid choice", "picker"],
  },
  {
    label: "Ask to resume or start over",
    section: "player",
    anchorTitle: "Play button behavior",
    keywords: ["resume prompt", "start over", "restart dialog", "continue watching prompt", "resume or restart"],
  },
  {
    label: "Resume where you left off",
    section: "player",
    anchorTitle: "Play button behavior",
    keywords: ["resume playback", "saved position", "continue watching", "start from beginning", "rewatch shows"],
  },
  {
    label: "Keep same source on next episode",
    section: "player",
    anchorTitle: "Play button behavior",
    keywords: ["same release", "next episode source", "binge same source", "keep addon", "sticky source"],
  },
  {
    label: "Stay in fullscreen after closing the player",
    section: "player",
    anchorTitle: "Play button behavior",
    keywords: ["keep fullscreen", "exit fullscreen", "fullscreen after close", "window mode", "fullscren"],
  },
  {
    label: "Volume pop-up while watching",
    section: "player",
    anchorTitle: "Play button behavior",
    keywords: ["volume hud", "volume overlay", "volume popup", "on screen volume", "scroll wheel volume", "osd"],
  },
  {
    label: "Pop-up position",
    section: "player",
    anchorTitle: "Play button behavior",
    keywords: ["volume position", "center", "top left", "top right", "hud placement", "overlay position"],
  },
  {
    label: "Auto",
    section: "player",
  ...
  },
  {
    ...
    section: "player",
    anchorTitle: "Player engine",
    keywords: ["embedded mpv", "separate window", "inline playback", "detached player", "external window"],
  },
  {
  ...
  },
  {
    ...
    section: "player",
    anchorTitle: "Player engine",
    keywords: ["true hdr", "hdr window", "real hdr", "hdr10", "brightness slider dimming", "separate playback window"],
  },
  {
    label: "True HDR, embedded",
    section: "player",
    anchorTitle: "Player engine",
    keywords: ["embedded hdr", "hdr inside harbor", "experimental hdr", "overlay controls", "floating controls"],
  },
  {
  ...
  },
  {
    ...
    section: "player",
    anchorTitle: "Player engine",
    keywords: ["bright line", "edge line", "monitor artifact", "d3d11", "compatibility present mode", "thin line fix"],
  },
  {
  ...
  },
  {
    ...
    section: "player",
    anchorTitle: "Player engine",
    keywords: ["bandwidth cap", "mbps", "speed test", "connection speed", "bitrate limit", "slow internet", "no limit"],
  },
  {
  ...
  },
  {
    ...
    section: "player",
    anchorTitle: "Aspect ratio",
    keywords: ["live aspect button", "aspect toggle in player", "show crop button", "mid playback ratio"],
  },
  {
    label: "Player audio",
    section: "player",
  ...
  },
  {
    ...
    section: "player",
    anchorTitle: "Audio",
    keywords: ["loudness normalization", "quiet dialogue", "loud scenes", "volume leveling", "dynamic normalizer"],
  },
  {
  ...
  },
  {
    ...
    section: "player",
    anchorTitle: "Audio",
    keywords: ["audio device", "speakers", "headphones", "receiver", "output select", "hdmi audio", "system default"],
  },
  {
    label: "Show the Skip button",
    section: "player",
    anchorTitle: "Skip intros",
    keywords: ["skip button", "skip intro button", "skip credits button", "dismiss skip", "hide skip"],
  },
  {
  ...
  },
  {
    ...
    section: "player",
    anchorTitle: "Skip intros",
    keywords: ["hide skip button", "skip button timeout", "auto dismiss", "5s 10s 15s 30s", "disappear"],
  },
  {
    label: "Next episode prompt",
    section: "player",
    anchorTitle: "Next episode prompt",
    keywords: ["up next", "next episode pill", "lead time", "prompt timing", "before episode ends", "auto lead"],
  },
  {
    label: "Auto-play next episode",
    section: "player",
    anchorTitle: "Next episode prompt",
    keywords: ["autoplay next", "binge watching", "continuous play", "auto next episode", "stop after episode"],
  },
  {
  ...
  },
  {
    ...
    section: "mpv",
    anchorTitle: "Picture quality",
    keywords: ["performance mode", "weak pc", "old laptop", "stutter fix", "lightweight", "battery", "fan noise"],
  },
  {
    label: "Balanced",
    section: "mpv",
  ...
  },
  {
    ...
    section: "mpv",
    anchorTitle: "Hardware acceleration",
    keywords: ["hwdec", "gpu decode", "force on", "cpu decode", "video glitches", "battery saving", "wont play"],
  },
  {
    label: "Picture adjustments",
    section: "mpv",
    anchorTitle: "Picture adjustments",
    keywords: ["picture dials", "image tweaks", "video adjustments", "color tuning", "one tap looks"],
  },
  {
  ...
  },
  {
    ...
    section: "mpv",
    anchorTitle: "Color & HDR",
    keywords: ["inverse tone mapping", "sdr to hdr", "fake hdr", "expand brightness", "hdr display boost"],
  },
  {
    label: "Slow or unstable connection",
    section: "mpv",
    anchorTitle: "Slow or unstable connection",
    keywords: ["buffering", "spotty wifi", "weak connection", "rebuffering", "head start", "pausing to buffer"],
  },
  {
    label: "Build a bigger buffer",
    section: "mpv",
    anchorTitle: "Slow or unstable connection",
    keywords: ["bigger buffer", "cache more", "preload video", "smoother on weak wifi", "buffer boost"],
  },
  {
    label: "Audio downmix",
    section: "mpv",
  ...
  },
  {
    ...
    section: "mpv",
    anchorTitle: "Audio",
    keywords: ["downmix stereo", "5.1 to stereo", "7.1", "quiet dialogue", "hollow sound", "headphones fix"],
  },
  {
  ...
  },
  {
    ...
    section: "mpv",
    anchorTitle: "Advanced (mpv.conf)",
    keywords: ["generated config", "compiled mpv conf", "preview options", "show config", "dials output"],
  },
  {
    label: "Enable Anime4K",
    section: "anime",
    anchorTitle: "Anime4K upscaling",
    keywords: ["anime4k on", "upscale anime", "sharper lines", "cleaner gradients", "real time upscale"],
  },
  {
  ...
  },
  {
    ...
    section: "anime",
    keywords: ["download shaders", "install anime4k", "shader pack", "one time setup", "get shaders"],
  },
  {
    label: "Re-download",
    section: "anime",
  ...
  },
  {
    ...
    section: "anime",
    anchorTitle: "Smooth motion",
    keywords: ["frame interpolation", "judder", "smooth panning", "motion smoothing", "fps boost", "drawn on twos"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["svp", "smooth video project", "60fps anime", "vapoursynth", "svpflow", "interpolation engine"],
  },
  {
    label: "Get SVP (free)",
    section: "anime",
  ...
  },
  {
    ...
    section: "anime",
    anchorTitle: "SVP frame interpolation",
    keywords: ["svp on", "real interpolation", "48fps", "60fps", "black screen svp", "restart playback"],
  },
  {
    label: "Apply SVP to",
    section: "anime",
    anchorTitle: "SVP frame interpolation",
    keywords: ["svp scope", "anime only", "all content", "movies and tv", "limit svp", "live action"],
  },
  {
    label: "Default / Stremio",
    section: "playerLayout",
    keywords: ["player theme", "chrome theme", "stremio layout", "harbor layout", "button order", "layout tabs"],
  },
  {
    label: "True black menus",
    section: "playerLayout",
    keywords: ["black menus", "pure black panels", "oled black", "ignore theme tint", "player menus"],
  },
  {
  ...
  },
  {
    label: "Time format",
    section: "playerLayout",
    keywords: ["elapsed remaining", "clock labels", "seek bar time", "remaining only", "timestamps", "time display"],
  },
  {
    label: "Volume control",
    section: "playerLayout",
    keywords: ["volume slider", "stepper", "icon only", "mute click", "volume widget style", "hover slider"],
  },
  {
    label: "Show P2P status chip",
    section: "playerLayout",
    keywords: ["p2p chip", "torrent status", "peers speed", "download progress overlay", "torrent chip"],
  },
  {
    label: "Save changes",
    section: "playerLayout",
  ...
  },
  {
    ...
    section: "playerLayout",
    keywords: ["reset to defaults", "reset profile", "factory defaults layout", "restore defaults", "wipe tweaks"],
  },
  {
    label: "Reset all ({n})",
    section: "hotkeys",
  ...
  },
  {
    ...
    section: "hotkeys",
    anchorTitle: "Behavior",
    keywords: ["confirm exit", "leave prompt", "close confirmation", "dont ask again", "quit confirm"],
  },
  {
    label: "Seek step",
    section: "hotkeys",
    anchorTitle: "Behavior",
    keywords: ["arrow jump", "seek amount", "skip seconds", "back forward step", "10 seconds", "jump length"],
  },
  {
    label: "Global",
    section: "hotkeys",
  ...
  },
  {
    ...
    section: "theme",
    anchorTitle: "Theme",
    keywords: ["color theme", "theme presets", "palette", "appearance", "look", "dark theme", "skins"],
  },
  {
    label: "Custom",
    section: "theme",
    anchorTitle: "Theme",
    keywords: ["custom palette", "build your own colors", "theme editor", "hand tuned colors", "diy theme"],
  },
  {
    label: "Background image",
    section: "theme",
    anchorTitle: "Background image",
    keywords: ["wallpaper", "backdrop image", "custom background", "background photo", "app background"],
  },
  {
    label: "Choose image",
    section: "theme",
    anchorTitle: "Background image",
    keywords: ["upload wallpaper", "pick image", "replace image", "jpeg png webp", "set background"],
  },
  {
    label: "Remove",
    section: "theme",
  ...
  },
  {
    ...
    section: "theme",
    anchorTitle: "Background image",
    keywords: ["dim slider", "darken background", "readability", "overlay strength", "background dim"],
  },
  {
    label: "Typography",
    section: "theme",
  ...
  },
  {
    ...
    section: "theme",
    anchorTitle: "Your themes",
    keywords: ["browse themes", "theme gallery", "apply theme", "one click theme", "library", "featured themes"],
  },
  {
    label: "Build a Theme",
    section: "theme",
    anchorTitle: "Your themes",
    keywords: ["theme studio", "create theme", "make your own theme", "no code theming", "open studio"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["poster size", "card size", "corner radius", "poster scale", "width height", "live preview"],
  },
  {
  ...
  },
  {
    ...
    section: "theme",
    anchorTitle: "Accessibility",
    keywords: ["bigger text", "ui scale", "readability", "4k scaling", "visual accessibility", "easier to read"],
  },
  {
    label: "Interface scale",
    section: "theme",
    anchorTitle: "Accessibility",
    keywords: ["ui zoom", "interface size", "scale slider", "bigger interface", "small text fix", "ultrawide"],
  },
  {
    label: "Show format chips on stream rows",
    section: "theme",
    anchorTitle: "Stream format chips",
    keywords: ["4k chip", "hdr chip", "codec badge", "audio badge", "hide chips", "resolution tags"],
  },
  {
    label: "Home hero",
    section: "theme",
  ...
  },
  {
    ...
    section: "theme",
    anchorTitle: "Trailer quality",
    keywords: ["auto trailer", "muted trailer", "backdrop trailer", "detail page video", "autoplay preview"],
  },
  {
  ...
  },
  {
    ...
    section: "theme",
    anchorTitle: "Seek bar",
    keywords: ["trickplay", "scrub thumbnails", "hover preview", "seek preview", "filmstrip", "frame preview"],
  },
  {
    label: "Bar style",
    section: "theme",
  ...
  },
  {
    ...
    section: "webhooks",
    anchorTitle: "Where alerts go",
    keywords: ["telegram alerts", "telegram webhook", "botfather", "send test", "telegram notifications"],
  },
  {
    label: "Bot token",
    section: "webhooks",
  ...
  },
  {
    ...
    section: "webhooks",
    anchorTitle: "What to send",
    keywords: ["library alerts", "saved shows notifications", "stremio library releases", "my shows"],
  },
  {
    label: "All upcoming",
    section: "webhooks",
  ...
  },
  {
    ...
    section: "webhooks",
    anchorTitle: "What to send",
    keywords: ["trakt watchlist alerts", "trakt upcoming", "trakt notifications", "watchlist pings"],
  },
  {
    label: "Anticipated",
    section: "webhooks",
  ...
  },
  {
    ...
    section: "webhooks",
    anchorTitle: "What to send",
    keywords: ["tracked people", "genres providers countries", "custom calendar alerts", "my calendar"],
  },
  {
    label: "Media types",
    section: "webhooks",
  ...
  },
  {
    ...
    keywords: ["attach screenshot", "screen recording", "upload clip", "drag and drop files", "evidence", "mp4 gif"],
  },
  {
    label: "Player log",
    section: "bug",
  ...
  },
  {
    ...
    section: "bug",
    anchorTitle: "Player log",
    keywords: ["export log", "save log to downloads", "harbor-mpv-log", "diagnostics file", "attach log"],
  },
  {
  ...
  },
  {
    ...
    section: "advanced",
    anchorTitle: "Updates",
    keywords: ["update check", "latest version", "check now", "update now", "install update", "restart to update"],
  },
  {
    label: "Get beta updates",
    section: "advanced",
    anchorTitle: "Updates",
    keywords: ["beta channel", "early builds", "prerelease", "beta opt in", "nightly", "back to stable"],
  },
  {
    label: "Roll back to an earlier build",
    section: "advanced",
    anchorTitle: "Updates",
    keywords: ["rollback", "downgrade", "previous version", "earlier build", "old installer", "broken beta"],
  },
  {
    label: "How is this build treating you?",
    section: "advanced",
    anchorTitle: "Updates",
    keywords: ["rate build", "build feedback", "better or worse", "feedback slider", "send rating", "beta rating"],
  },
  {
  ...
  },
  {
    ...
    section: "advanced",
    anchorTitle: "Downloads",
    keywords: ["pick folder", "change download location", "different drive", "reset to default", "open folder"],
  },
  {
    label: "Privacy",
    section: "advanced",
  ...
  },
  {
    ...
    section: "advanced",
    anchorTitle: "Privacy",
    keywords: ["adblock", "block trackers", "analytics blocking", "tracker requests", "no telemetry", "ad blocking"],
  },
  {
    label: "System tray",
    section: "advanced",
  ...
  },
  {
    ...
    section: "advanced",
    anchorTitle: "Custom code",
    keywords: ["custom css", "custom js", "custom html", "modding", "inject code", "user styles", "power user"],
  },
  {
    label: "Custom CSS",
    section: "advanced",
    anchorTitle: "Custom code",
    keywords: ["css override", "restyle", "user styles", "retheme buttons", "stylesheet", "live injected"],
  },
  {
    label: "Custom JS",
    section: "advanced",
...
export function SettingsNav({
  ...
  const optionMatches = useMemo<SettingsOption[] | null>(() => {
    ...
    return SETTINGS_OPTIONS.filter(
      (o) =>
        o.label.toLowerCase().includes(trimmed) || (o.keywords ?? []).some((k) => k.toLowerCase().includes(trimmed)),
    );
  }, [trimmed]);
  ...
  const debridKeys = [settings.rdKey, settings.tbKey, settings.adKey, settings.pmKey, settings.dlKey].filter(
    Boolean,
  ).length;
  ...
  const langChip =
    settings.preferredLanguages.length === 0
      ...
      : settings.preferredLanguages.length > 1
        ? "MULTI"
        : (LANG_ABBR[settings.preferredLanguages[0]] ?? settings.preferredLanguages[0].slice(0, 3).toUpperCase());
            ...
            {chip && (
              <span
                className={`rounded-md px-1.5 py-0.5 text-[10px] font-medium tracking-wide ${
                  chip === "live" || chip === "via relay" ? "bg-accent/15 text-accent" : "bg-canvas/70 text-ink-subtle"
                }`}
              >
                {chip}
              </span>
