  ...
  return (
    <div className="border-b border-edge-soft pb-12 mb-12">
      <div className="mb-8 flex items-baseline justify-between gap-4">
        <h2 className="font-display text-[22px] font-medium tracking-tight text-ink">{t("Documentation")}</h2>
      ...
      >
        <ReactMarkdown
          ...
          components={{
            ...
            h2: (p) => (
              <h4 className="mt-5 mb-2 font-display text-[17px] font-medium tracking-tight text-ink">{p.children}</h4>
            ),
            h3: (p) => (
            ...
            h4: (p) => <h6 className="mt-3 mb-1 text-[13px] font-semibold text-ink">{p.children}</h6>,
            ...
            details: (p) => (
              <details className="my-3 rounded-xl border border-edge-soft bg-canvas/40 p-3">{p.children}</details>
            ),
            summary: (p) => (
              <summary className="cursor-pointer text-[13.5px] font-semibold text-ink">{p.children}</summary>
            ),
            table: (p) => (
